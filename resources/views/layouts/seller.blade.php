            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ auth("seller")->user()->image ? auth("seller")->user()->image : URL::to("/backend/assets/images/users/1.jpg") }}" alt="user" class="rounded-circle" width="31"></a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated">
                            <a class="dropdown-item" href="{{ route("seller.dashboard.index")."?edit=true" }}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="{{ route("seller.dashboard.index") }}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>

                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-tag"></i><span class="hide-menu">Inquiry </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{ route("seller.inquiry.index") }}" class="sidebar-link"><i class="mdi mdi-view-list"></i><span class="hide-menu"> All Inquiries </span></a></li>
                            <li class="sidebar-item"><a href="{{ route("seller.inquiry.create") }}" class="sidebar-link"><i class="mdi mdi-plus-circle"></i><span class="hide-menu"> Add Inquiry </span></a></li>
                        </ul>
                    </li>

                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-tag"></i><span class="hide-menu">Quotation </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{ route("seller.quotation.index") }}" class="sidebar-link"><i class="mdi mdi-view-list"></i><span class="hide-menu"> All Quotations </span></a></li>
                            {{--<li class="sidebar-item"><a href="{{ route("seller.quotation.create") }}" class="sidebar-link"><i class="mdi mdi-plus-circle"></i><span class="hide-menu"> Add Quotation </span></a></li>--}}
                        </ul>
                    </li>
